...
(function(){
  ...
  function applySitePayload(payload){
    ...
    nset(obj,'appearance', chosenDD.appearanceDescription || nget(genDD,'appearanceDescription') || '');
    ...
    nset(obj,'lineage.dropdownSelectionJson', JSON.stringify({generator:genDD, fullSitePayload:payload}, null, 2));
    ...
    nset(obj,'pronouns.reflexive', pron.reflexive || '');    nset(obj,'fallbackEtc', JSON.stringify(payload, null, 2));
